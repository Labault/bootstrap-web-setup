...
sed -i.bak '1s/.*/# depuis PROJET/' "$p/.shellcheckrc"
rm -f "$p/.shellcheckrc.bak"
sed -i.bak '1s/.*/# depuis TEMPLATE/' "$WORK/repo/templates/common/.shellcheckrc"
rm -f "$WORK/repo/templates/common/.shellcheckrc.bak"
